  ...
  return (
    <div className="rounded-xl overflow-hidden shadow-lg">
      <div className="relative flexCenter group overflow-hidden transition-all duration-100">
        ...
        ><FaSearch className="scale-125 hover:rotate-90 hover:scale-125 transition-all duration-200"/></Link>
      ...
      <div className="p-4 overflow-hidden">
        ...
        <div className="flex gap-5">
          ...
          <div className="text-[#ff813f] bold-16 line-through">$ {old_price}.00</div>
        </div>
      </div>
    </div>
  );
