  ...
  return (
    <section className="relative bg-hero bg-cover bg-no-repeat h-screen w-full">
      <div className="max_padd_container relative top-32 xs:top-52">
        <h1 className="h1 capitalize max-w-[37rem]">Find Your Favorite Product</h1>
        <p className="text-gray-50 regular-16 mt-6 max-w-[35rem]">
          Welcome to our online shop with top brands and high-quality products.
          Find the latest tech, stylish clothing, and unique home decor. Enjoy
          fast shipping and excellent service. Start exploring now!
        </p>
